        ...
        <section class="section section-components">
            ...
            <div class="row">
                <div class="col-sm-3 col-6">
                    ...
                    <img src="{{ asset('img/theme/team-1-800x800.jpg')}}" alt="Rounded image"
                ...
                <div class="col-sm-3 col-6">
                    ...
                    <img src="{{ asset('img/theme/team-2-800x800.jpg')}}" alt="Circle image"
                ...
                <div class="col-sm-3 col-6 mt-5 mt-sm-0">
                    ...
                    <img src="{{ asset('img/theme/team-3-800x800.jpg')}}" alt="Raised image"
                ...
                <div class="col-sm-3 col-6 mt-5 mt-sm-0">
                    ...
                    <img src="{{ asset('img/theme/team-4-800x800.jpg')}}" alt="Raised circle image"
